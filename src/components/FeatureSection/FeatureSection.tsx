  ...
  return (
    <section className='feature-section'>
      ...
      <div className='feature-section__content'>
        <h2 className='feature-section__title'>We Provide Many Features You Can Use</h2>
        ...
        <ul className='feature-section__list'>
          {featuresList.map((feature) => (
            <li key={feature} className='feature-section__listItem'>
              <img src={String(CheckIcon)} alt='Check Icon' className='feature-section__listIcon' />
              {feature}
            </li>
          ))}
        </ul>
